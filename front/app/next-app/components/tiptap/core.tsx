// src/components/tiptap/core.tsx
...
const HeadingButton: FC<HeadingButtonProps> = ({ editor, level }) => {
  const isHeadingActive = editor?.isActive("heading", { level: level });
  ...
  return (
    <Button
      variant={isHeadingActive ? "default" : "outline"}
      onClick={() => onClick()}
    >
      H{level}
    </Button>
...
const Tiptap = () => {
  ...
  return (
    <div className={cn("flex flex-col gap-4 rounded-md bg-white p-4")}>
